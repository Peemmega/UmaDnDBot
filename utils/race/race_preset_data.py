...
_RACE_STORIES = {
    "OkaSho": "สนามแรกของ Japanese Triple Tiara สำหรับสาวม้ารุ่น Classic.",
    "SatsukiSho": "ด่านแรกของ Japanese Triple Crown และบททดสอบ 2,000 เมตรของสาวม้ารุ่น Classic.",
    "JapaneseOaks": "สนามที่สองของ Japanese Triple Tiara บนระยะ 2,400 เมตร.",
    "JapaneseDerby": "Tokyo Yushun คือการแข่งขันที่มีเกียรติสูงสุดรายการหนึ่งสำหรับสาวม้ารุ่น Classic ของญี่ปุ่น.",
    "KikukaSho": "บทสรุป Japanese Triple Crown และบททดสอบระยะ 3,000 เมตร.",
    "ShukaSho": "บทสรุป Japanese Triple Tiara สำหรับสาวม้ารุ่น Classic.",
    "TennoShoSpring": "รายการ GI ระยะไกลอันทรงเกียรติในฤดูใบไม้ผลิสำหรับสาวม้ารุ่น Senior.",
    "TennoShoAutumn": "รายการ GI สำคัญของฤดูใบไม้ร่วงสำหรับสาวม้ารุ่น Senior บนสนาม Tokyo 2,000 เมตร.",
    "JapanCup": "การแข่งขันนานาชาติ GI ชั้นนำของญี่ปุ่นสำหรับสาวม้ารุ่น Senior จัดที่ Tokyo Racecourse.",
    "ArimaKinen": "Grand Prix ปลายปีสำหรับสาวม้ารุ่น Senior ซึ่งคัดเลือกผู้ร่วมแข่งจากความนิยมของแฟน ๆ.",
    "TakarazukaKinen": "Grand Prix ช่วงกลางปีสำหรับสาวม้ารุ่น Senior ที่ผู้ร่วมแข่งคัดเลือกจากคะแนนโหวตของแฟน ๆ.",
    "FilliesRevue": "สนาม Trial Race สำคัญสู่ Oka Sho สำหรับสาวม้ารุ่น Classic.",
    ...
    "KobeShimbunHai": "หนึ่งในสนาม Trial Race หลักก่อน Kikuka Sho สำหรับสาวม้ารุ่น Classic.",
    "AsahiHaiFuturityStakes": "แชมป์เปี้ยนชิพ GI ระยะไมล์ปลายปีสำหรับสาวม้ารุ่น Junior.",
    "HanshinJuvenileFillies": "แชมป์เปี้ยนชิพ GI ปลายปีสำหรับสาวม้ารุ่น Junior.",
    "OsakaHai": "GI ระยะ 2,000 เมตรของฤดูใบไม้ผลิ และหนึ่งในรายการหลักของสาวม้ารุ่น Senior.",
    "AobaSho": "สนาม Trial Race ที่มอบเส้นทางสำคัญสู่ Japanese Derby.",
    "FloraStakes": "สนาม Trial Race ของสาวม้ารุ่น Classic ก่อน Japanese Oaks.",
    "NHK": "GI ระยะไมล์สำหรับสาวม้ารุ่น Classic ซึ่งเป็นเป้าหมายสำคัญนอกสาย Classic ระยะกลาง.",
    "YasudaKinen": "GI ระยะไมล์ชั้นนำของฤดูใบไม้ผลิสำหรับสาวม้ารุ่น Senior.",
    "FebruaryStakes": "GI ดินระยะไมล์ชั้นนำของ JRA สำหรับสาวม้ารุ่น Senior ที่ Tokyo Racecourse.",
    "VictoriaMileTokyo": "GI ระยะไมล์ของสาวม้ารุ่น Senior ในฤดูใบไม้ผลิ.",
    ...
    "YayoiSho": "สนาม Trial Race ระยะ 2,000 เมตรสำหรับสาวม้ารุ่น Classic ก่อน Satsuki Sho.",
    "StLiteKinen": "สนาม Trial Race ช่วงฤดูใบไม้ร่วงสำหรับผู้มุ่งสู่ Kikuka Sho.",
    "HopefulStakes": "GI ปลายปีระยะ 2,000 เมตรสำหรับสาวม้ารุ่น Junior และเวทีชี้วัดดาวรุ่งสาย Classic.",
    "SprintersStakes": "GI ระยะสปรินต์ 1,200 เมตรชั้นนำของฤดูใบไม้ร่วงสำหรับสาวม้ารุ่น Senior.",
    "ChampionsCup": "GI ดินระยะกลางชั้นนำปลายปีของ JRA สำหรับสาวม้ารุ่น Senior.",
    "TakamatsunomiyaKinen": "GI ระยะสปรินต์ 1,200 เมตรชั้นนำของฤดูใบไม้ผลิสำหรับสาวม้ารุ่น Senior.",
    "QueenElizabethIICup": "GI สำคัญสำหรับสาวม้ารุ่น Senior ในฤดูใบไม้ร่วง.",
    "MileChampionship": "GI ระยะไมล์ชั้นนำของฤดูใบไม้ร่วงสำหรับสาวม้ารุ่น Senior ที่ Kyoto Racecourse.",
    "JapanDirtDerby": "รายการ JpnI สำหรับสาวม้ารุ่น Classic บนดิน ซึ่งเป็นเวทีหลักของสาย Dirt Classic.",
    "TokyoDaishoten": "Grand Prix ดิน JpnI ช่วงสิ้นปีสำหรับสาวม้ารุ่น Senior ที่ Oi Racecourse.",
    "TeioSho": "รายการ JpnI ดินระยะกลางสำคัญของฤดูร้อนสำหรับสาวม้ารุ่น Senior ที่ Oi.",
    "ZenNipponJuniorYushun": "รายการ JpnI สำหรับสาวม้ารุ่น Junior บนดิน และเวทีชี้วัดดาวรุ่งสาย Dirt.",
    "KawasakiKinen": "รายการ JpnI ดินระยะกลางอันทรงเกียรติสำหรับสาวม้ารุ่น Senior ที่ Kawasaki Racecourse.",
    "KashiwaKinen": "รายการ JpnI ดินระยะไมล์สำคัญสำหรับสาวม้ารุ่น Senior ที่ Funabashi Racecourse.",
    "MCNambuHai": "รายการ JpnI ดินระยะไมล์ประจำฤดูใบไม้ร่วงสำหรับสาวม้ารุ่น Senior ที่ Morioka Racecourse.",
    "HakodateJuniorStakes": "GIII ฤดูร้อนสำหรับสาวม้ารุ่น Junior เปิดโอกาสให้ดาวรุ่งแจ้งเกิดที่ Hakodate.",
    "NiigataJuniorStakes": "GIII สำหรับสาวม้ารุ่น Junior บนระยะไมล์ เป็นด่านสร้างชื่อช่วงฤดูร้อน.",
    "DiamondStakes": "GIII ระยะไกล 3,400 เมตรของ Tokyo สำหรับสาวม้ารุ่น Senior สายความอึด.",
    "ChunichiShimbunHai": "GIII ระยะ 2,000 เมตรของ Chukyo ในฤดูหนาว สำหรับสาวม้ารุ่น Senior สายระยะกลาง.",
    "KyotoJuniorStakes": "GIII สำหรับสาวม้ารุ่น Junior ระยะ 2,000 เมตรที่ Kyoto.",
    "SaudiArabiaRoyalCup": "GIII ระยะไมล์ของ Tokyo สำหรับสาวม้ารุ่น Junior ในช่วงต้นฤดูกาล.",
    "Aoi Stakes": "GIII ระยะสปรินต์สำหรับสาวม้ารุ่น Classic ที่ Kyoto Racecourse.",
}
