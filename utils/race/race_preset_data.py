...
_RACE_STORIES = {
    "OkaSho": "ศึกสปรินต์ไมล์ 1,600 เมตร บนกลีบซากุระที่ผลิบาน เวทีประชันความเร็วเพื่อช่วงชิงมงกุฎแรกแห่งราชินี",
    "SatsukiSho": "ด่านแรกของสามมงกุฎ บททดสอบความเร็วและไหวพริบระยะ 2,000 เมตร สังเวียนคัดกรองสาวม้าที่เฉียบคมและว่องไวที่สุดในรุ่น ผู้ที่เร็วที่สุดเท่านั้นที่จะคว้าชัย",
    "JapaneseOaks": "2,400 เมตร ที่ไม่เพียงแต่เร็ว แต่ต้องมีหัวใจทรหดและพละกำลังที่สง่างามสมดั่งราชินีแห่งโอ็ค",
    "JapaneseDerby": "จุดสูงสุดของสาวม้ารุ่นคลาสซิกหนึ่งชีวิต หนึ่งหนย่อมแลกทุกอย่างเพียงเพื่อได้จารึกชื่อในดาร์บี้ตลอดกาล ผู้ซึ่งโชคดีที่สุดจะชี้นำพา",
    "KikukaSho": "ด่านสุดท้ายแห่งเกียรติยศสามมงกุฎ 3,000 เมตร สังเวียนสังเวียนแห่งผู้ที่แข็งแกร่งที่สุดเท่านั้นจะยืนหยัด",
    "ShukaSho": "ขับเคี่ยวบนโค้งในสุดแคบของสนามเกียวโต บทสรุปมงกุฎสุดท้าย ผู้ใดกันคือราชีนีที่แท้จริง?",
    "TennoShoSpring": "3,200 เมตรแห่งความทรหด ยุทธการแย่งชิงโล่องค์จักรพรรดิของผู้แข็งแกร่ง",
    "TennoShoAutumn": " สงครามความเร็วระยะ 2,000 เมตร เกียรติยศแบะความเร็ว ราชาทางเรียบ !",
    "JapanCup": "ยอดนักกรีฑาแห่งโลกาทั้งหลายจงดู สลักไว้ในความทรงจำ นี้คือพลังของอาชาสาวแห่งอุทัยทิศ!",
    "ArimaKinen": "ความฝันแห่งหยาดน้ำตา อันตัวข้าจักถูกเล่านขานชั่วกาลนาน",
    "TakarazukaKinen": "สังเวียนชี้ชะตาระยะกลาง 2,200 เมตร ดาราแห่งวสันตฤดู",
    ...
    "AsahiHaiFuturityStakes": "ได้ยินจากรุ่นพี่ว่าทางตรงเร็วที่สุด (แต่นี่มันไมล์นะ!?)",
    "HanshinJuvenileFillies": "รุ่นน้องแล้วไง ก็เก่งเหมือนกันนะคะ!",
    "OsakaHai": " ปะทะซีเนียร์หัวกะทิ ประตูบานแรกสู่การครองบัลลังก์ระยะกลางประจำปี!",
    ...
    "YasudaKinen": "ไมล์ทางตรงมหาโหด ใครไม่ยอมไปก่อนเลย!",
    "FebruaryStakes": "สังเวียนแรกของเหล่าปีศาจสนามฝุ่น",
    "VictoriaMileTokyo": "เทียร่าลงสนาม ฉันนี้แหละยอดสตรีสนามไมล์!",
    ...
    "HopefulStakes": "จุดกำเนิดแห่งความหวัง ใครกันนะดางเด่นแห่งยุคถัดไป",
    "SprintersStakes": "68 วินาที ชี้ชะตาราชาและราชินีแห่งความเร็วระยะสั้น",
    "ChampionsCup": "บทสถาปนาแชมป์แห่งสนามดิน",
    "TakamatsunomiyaKinen": "1,200 เมตร สายฟ้า ความเร็ว สายลม สปีด!!",
    "QueenElizabethIICup": "ผู้ปราชัยจักก้มลงสู่ธรณี เหตุเพราะเบื้องหน้าแย้ม ราชีรีแห่งกรีฑาสถาน",
    "MileChampionship": "1,600 เมตรนี้ใครจะคมที่สุด ? ก็ต้องเป็นฉันอยู่แล้ว!",
    "JapanDirtDerby": "อย่าได้ลืมซะล่ะ สามมงกุฎเองก็มีสายดินเหมือนกันนะคะ!",
    "TokyoDaishoten": "บทสรุปขิงเจ้าแห่งฝุ่น ไม่ว่าจะมากจากที่ใด ฉันจะปดขยี้มันเอง",
    "TeioSho": "มาโชว์ลวดลายยามค่ำกันหน่อยทุกโค๊น!",
    "ZenNipponJuniorYushun": "คอยดูเถอะค่ะรุ่นพี่ สาวม้าสนามดืนเองก็มีของดีอยู่เหมือนกัน!",
    "KawasakiKinen": "โค้งแค๊บคาวาซากิ ร้องโอดกันทุกคน!",
    "KashiwaKinen": "ฟุนาบาชิคือที่ของความเร็ว! สายลมบนทะเลทราย!",
    "MCNambuHai": "ไมล์สนามดินทางเรียบ เร็วก็พอแล้วเนาะ",
