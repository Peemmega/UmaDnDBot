...
def get_web_timing_snapshot(player: dict, finish_distance: int, now: float | None = None) -> dict:
    ...
    _sync_public_state(player, now)
    return {
        "phase": player["web_timing_phase"],
        "tempo_level": player["tempo_level"],
        "tempo_label": player["tempo_label"],
        "speed_multiplier": player["speed_multiplier"],
        "acceleration_multiplier": player["acceleration_multiplier"],
        "gauge_speed_multiplier": player["gauge_speed_multiplier"],
        "current_speed": player["current_speed"],
        "acceleration": player["acceleration"],
        "zone_active": player["zone_active"],
        ...
        "zone_remaining_seconds": player["zone_remaining_seconds"],
        "zone_used": player["zone_used"],
