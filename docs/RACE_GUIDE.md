...
Stamina ในการแข่งขันเป็นค่าพลังงานแยกจาก Stat โดยเริ่มเต็มตาม Stat Stamina ทุกครั้งที่ Run จะจ่ายค่าตามเส้นทางและเลน (ยกเว้นเทิร์นแรกที่ไม่คิดตัวคูณเลน)
...
- **ค่า Stamina ของเลน:** เลน 1 ใช้ 90% ของค่าพื้นฐาน, เลน 2 ใช้ 100%, และเพิ่ม 10% ต่อเลนจนถึงเลน 6 ที่ 140%
...
- Lane multiplier: `L1 0.90`, `L2 1.00`, `L3 1.10`, `L4 1.20`, `L5 1.30`, `L6 1.40`
- Draft drain = `round(lane-adjusted drain × 0.90)`
